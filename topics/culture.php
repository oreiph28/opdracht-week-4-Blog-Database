...
//=========================sending to database=========================
$sqlCommand = "INSERT INTO culture (name, title, blog,email,file)
...
$sqlCommand ="SELECT * FROM culture ORDER BY ID DESC LIMIT 15";
$sqlUitvoer	= mysqli_query($conn,$sqlCommand);
...
<script>
    ...
    location.replace("../index_blog_culture.php")
